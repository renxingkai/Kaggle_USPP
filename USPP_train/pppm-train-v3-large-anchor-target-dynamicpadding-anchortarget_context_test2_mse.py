...
class CFG:
    ...
    task = 'deberta-v3-large-anchor-target-310-dynamicpadding-anchortarget-context_text_test2_mse_fold3'
...
# train['text'] = ''
# for i in  range(len(train)):
#     train['text'][i] = train['anchor'][i] + ' [SEP] ' + train['target'][i] + '; ' + train['anchor_target'][i].replace(train['target'][i], '') + ' [SEP] ' + train['context_text'][i]
...
def create_optimizer(model):
    ...
    roberta_parameters = named_parameters[:387]
